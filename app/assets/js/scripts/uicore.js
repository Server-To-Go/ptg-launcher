...
const loggerUICore = LoggerUtil1(
  "%c[UICore]",
  "color: #000668; font-weight: bold"
);
const loggerAutoUpdater = LoggerUtil1(
  "%c[AutoUpdater]",
  "color: #000668; font-weight: bold"
);
const loggerAutoUpdaterSuccess = LoggerUtil1(
  "%c[AutoUpdater]",
    ...
    switch (arg) {
      ...
      case "update-available":
        ...
        if (process.platform === "darwin") {
          info.darwindownload = `https://github.com/ItsmeFawaz/unsorted-guy-repository/releases/download/v${
            info.version
